        ...
        <main className="flex-1 ml-56 p-6">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p style={{ color: dashboardColors.text.secondary }}>Loading agents...</p>
            </div>
          </div>
        </main>
      </div>
        ...
        <main className="flex-1 ml-56 p-6">
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="text-red-600 mb-4">Error fetching agents: {error}</p>
              <button 
      ...
      <main className="flex-1 ml-56 p-6 transition-all duration-300">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h1 className="text-3xl font-bold mb-2" style={{ color: dashboardColors.text.primary }}>
                Agent Management
              </h1>
            ...
            <div className="flex gap-3">
              {selectedAgents.length > 0 && (
                <button
                  ...
                  className="px-4 py-2 rounded-lg text-white font-medium transition-all duration-200 hover:scale-105 flex items-center"
                  style={{ background: dashboardColors.status.error }}
                >
              ...
              <Link 
                ...
                className="px-6 py-2 rounded-lg text-white font-medium transition-all duration-200 hover:scale-105 flex items-center"
          ...
          <div className="bg-white rounded-xl p-4 mb-6" style={{ boxShadow: dashboardColors.shadow.sm }}>
            <div className="flex items-center justify-between">
              <div className="flex items-center flex-1 max-w-md">
                <div className="relative flex-1">
                  <svg className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5" style={{ color: dashboardColors.text.muted }} fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-4 ml-4">
                <span className="text-sm" style={{ color: dashboardColors.text.secondary }}>
